...
class Command(BaseCommand):
    help = (
        ...
        "ابتدا کل فایل اعتبارسنجی می‌شود؛ بازی‌ها بر اساس شمارهٔ بازی به‌روزرسانی می‌شوند "
        "تا پیش‌بینی‌ها، امتیازها و نتایج ثبت‌شده حفظ شوند."
    )

    def add_arguments(self, parser):
        parser.add_argument("--file", default=str(DATA_PATH),
    ...
    def handle(self, *args, **options):
        ...
        # so replacing them outright is safe.
