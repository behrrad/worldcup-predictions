        ...
        "navigation": [
            {
                ...
                "items": [
                    ...
                    {"title": consts.V_PLAYER_CANDIDATE_PLURAL, "icon": "person",
                     "link": reverse_lazy("admin:predictions_playercandidate_changelist")},
                    {"title": consts.V_TOURNAMENT_OUTCOME_PLURAL, "icon": "workspace_premium",
                     "link": reverse_lazy("admin:predictions_tournamentoutcome_changelist")},
                    {"title": consts.V_BONUS_PREDICTION_PLURAL, "icon": "military_tech",
                     "link": reverse_lazy("admin:predictions_bonusprediction_changelist")},
                    {"title": consts.V_BONUS_SCORE_PLURAL, "icon": "stars",
                     "link": reverse_lazy("admin:predictions_bonusscore_changelist")},
                ],
            },
            {
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        consts.THROTTLE_SCOPE_SCOREBOARD: os.environ.get("THROTTLE_RATE_SCOREBOARD", consts.THROTTLE_RATE_SCOREBOARD),
    },
}
